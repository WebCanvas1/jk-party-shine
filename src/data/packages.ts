...
export const packages: Package[] = [
  ...
  },
  {
    ...
    features: [
      "Pastel balloon arch",
      "Mini table & chair setup",
      "Themed decorations",
      "Cake plinth & dessert styling",
      "Lollie jars & party favours",
  ...
  },
  {
    ...
    features: [
      "Premium bar setup with backdrop",
      "Whisky, beer & champagne styling",
      "Crystal glassware & decanters",
      "Buckets with ice",
      "Neon bar signage",
      "Bar styling with candles & florals",
      "Full setup & pack down",
    ],
    image: drinksbar,
  },
  {
    ...
    features: [
      "Premium artificial floral arch",
      "Choice of colour palette",
      "Draped backdrop options",
      "LED candles around the base",
  ...
  },
  {
    ...
    features: [
      "Pink & blue balloon garland",
      "“Boy or Girl” neon sign",
      "Dessert table with cupcakes & cake plinth",
      "Personalised welcome sign",
      "Table styling for guests",
      "Reveal element (smoke, balloon or cake)",
      "Full setup & pack down",
    ],
    image: gender,
  },
  {
    ...
    features: [
      ...
      "“Baby Shower” signage",
      "Dessert table with cake plinth",
      "Macarons & dessert styling",
      "Plush teddy & decorative props",
      "LED candles & soft lighting",
      "Personalised welcome sign",
      "Full setup & pack down",
    ],
    image: babyshower,
