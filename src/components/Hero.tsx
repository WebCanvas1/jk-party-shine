...
const Hero = () => {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-purple-900 via-purple-800 to-black">
      ...
      <div className="container relative py-20 md:py-32 flex flex-col items-center text-center">
        ...
        <img
          src={logo}
          alt="JK Party Hire"
          className="h-28 md:h-36 w-28 md:w-36 rounded-full glow-purple animate-pulse-glow mb-8"
        />
        ...
        <a
          href="tel:0410235755"
          className="mt-8 flex items-center gap-2 text-primary hover:text-primary-glow transition-colors"
        >
